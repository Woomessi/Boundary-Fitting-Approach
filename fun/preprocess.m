%PREPROCESS   Preprocess the STL model.
%
...
%   -90 degree.
%
function [point,facet,normal,z_max,z_min,size_facet,size_point] = preprocess(filename,I)
...
[~,index_minx] = min(point(:,1));
pris = -point(index_minx,:);
